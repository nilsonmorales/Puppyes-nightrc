...
TK_LIBS='-lX11 -lXss -lXext -lXft    -lpthread -ldl -lz  -lpthread -lieee -lm'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/root/my-documents/tk8.6.0/unix -ltk8.6'
...
# compiled.
TK_SRC_DIR='/root/my-documents/tk8.6.0'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/root/my-documents/tk8.6.0/unix -ltkstub8.6'
...
TK_BUILD_STUB_LIB_PATH='/root/my-documents/tk8.6.0/unix/libtkstub8.6.a'

...
# build directory.
TCL_BUILD_LIB_SPEC='-L/root/my-documents/tcl8.6.0/unix -ltcl8.6'
...
# compiled.
TCL_SRC_DIR='/root/my-documents/tcl8.6.0'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/root/my-documents/tcl8.6.0/unix -ltclstub8.6'
...
TCL_BUILD_STUB_LIB_PATH='/root/my-documents/tcl8.6.0/unix/libtclstub8.6.a'

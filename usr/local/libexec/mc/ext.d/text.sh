...
do_view_action() {
    ...
    man)
        ...
        */log/*|*/logs/*)
            ...
            ;;
        *)
            { zsoelim "${MC_EXT_FILENAME}" 2>/dev/null || cat "${MC_EXT_FILENAME}"; } | nroff  -man
            ;;
        esac
        ;;
    pod)
        pod2man "${MC_EXT_FILENAME}" | nroff  -man
        ;;
    nroff.me)
        nroff  -me "${MC_EXT_FILENAME}"
        ;;
    nroff.ms)
        nroff  -ms "${MC_EXT_FILENAME}"
        ;;
    man.gz|man.bz|man.bz2|man.lzma|man.xz)
        ...
        */log/*|*/logs/*)
            ...
            ;;
        *)
            ${unpacker} "${MC_EXT_FILENAME}" | nroff  -man
            ;;
        esac
        ;;
    *)
...
do_open_action() {
    ...
    man)
        ...
        *)
        ...
        ;;
    pod)
        pod2man "${MC_EXT_FILENAME}" | nroff  -man | ${pager}
        ;;
    nroff.me)
        nroff  -me "${MC_EXT_FILENAME}" | ${pager}
        ;;
    nroff.ms)
        nroff  -ms "${MC_EXT_FILENAME}" | ${pager}
        ;;
    man.gz|man.bz|man.bz2|man.lzma|man.xz)
        case "${MC_EXT_CURRENTDIR}"/"${MC_EXT_FILENAME}" in
        */log/*|*/logs/*)
